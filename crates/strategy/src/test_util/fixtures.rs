...
//! for [`Ticker`](tickglide_core::Ticker),
//! [`MarketKind`](tickglide_core::MarketKind), and
//! [`Venue`](tickglide_core::Venue) values used across `test_util`'s
//! own tests and available to consumers building [`Instrument`]s for
//! their own snapshot fakes.
//!
//! [`Instrument`]: tickglide_core::Instrument
...
/// Common [`Ticker`](tickglide_core::Ticker) fixtures for tests.
pub mod tickers {
    use tickglide_core::Ticker;
...
/// Common [`MarketKind`](tickglide_core::MarketKind) fixtures for tests.
pub mod market_kinds {
    use tickglide_core::MarketKind;
...
/// Common [`Venue`](tickglide_core::Venue) fixtures for tests.
pub mod venues {
    use tickglide_core::Venue;
